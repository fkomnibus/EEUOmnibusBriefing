...
### CBAM Carbon Credits Historical Price Comparison
```{=html}
<div>
...
<script>
  function calculateCBAM() {
    ...
    document.getElementById('result_weekly').innerText =
      `Carbon Certificate Estimate: €${totalWeekly.toFixed(2)} (based on EU ETS Allowances Weekly Average Closing Prices)`;

    document.getElementById('result_quarterly').innerText =
      `Quarterly Estimate: €${totalQuarterly.toFixed(2)} (based on EU ETS Allowance Quarterly Average Closing Prices)`;
  }
</script>
