...
<div>
  ...
  <label>Weekly Average of EU ETS Allowance Closing Prices (€/tCO₂e): <input type="number" id="Weekly Price" value="90"></label><br>
  <label>Quarterly Average of EU ETS Allowance Closing Prices (€/tCO₂e): <input type="number" id="Quarterly Price" value="90"></label><br>
...
<script>
  function calculateCBAM() {
    ...
    const quartprice = parseFloat(document.getElementById('Quarterly Price').value);
    const weekprice = parseFloat(document.getElementById('Weekly Price').value);
    const total = weight * ef * weekprice;
    document.getElementById('result').innerText = `Total CBAM Certificate Cost based on Weekly EU ETS Allowance Closing Prices: €${total.toFixed(2)}`;
    const total = weight * ef * quartprice;
    document.getElementById('result').innerText = `Total CBAM Certificate Cost based on Quarterly EU ETS Allowance Closing Prices: €${total.toFixed(2)}`;
  }
</script>
