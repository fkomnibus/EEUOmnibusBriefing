...
fig.write_html("interactive_graph.html", include_plotlyjs='cdn', full_html=False, div_id='graph')
```
...
<div>
  ...
  <label>Weekly CBAM Price (€/tCO₂e): <input type="number" id="price_weekly" value="0" step="0.1"></label><br>
  <label>Quarterly CBAM Price (€/tCO₂e): <input type="number" id="price_quarterly" value="0" step="0.1"></label><br>
...
<script>
  function calculateCBAM() {
    ...
    const price_weekly = parseFloat(document.getElementById('price_weekly').value) || 0;
    const price_quarterly = parseFloat(document.getElementById('price_quarterly').value) || 0;
    const price = price_weekly || price_quarterly;
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (graphDiv && graphDiv.on) {
      graphDiv.on('plotly_click', function(data) {
        ...
        if (traceName.includes("Weekly")) {
          document.getElementById('price_weekly').value = price.toFixed(2);
        } else if (traceName.includes("Quarterly")) {
          document.getElementById('price_quarterly').value = price.toFixed(2);
        }
